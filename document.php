    ...
    <aside id="sidebar">
        ...
        <div class="main p-5">
            <div class="d-flex justify-content-between p-4">
                ...
                <h1>Documents</h1>
                <a href="#" class=" btn btn-primary text-center" data-toggle="modal" data-target="#adddocument">+ Documents</a>
                ...
                <table class="table   table-bordered ">
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr>
                                    <td><?php echo $cnt; ?></td>
                                    <td><?php echo htmlentities($result->Documentname); ?></td>
                                    <td><?php echo htmlentities($result->Description); ?></td>
                                    <td>
                                        <a href="document.php?del=<?php echo htmlentities($result->id); ?>"><i class="lni lni-trash-can p-2" onclick="return confirm('Do you really want to delete?')"></i></a>
                                        <a href="updatedocument.php?id=<?php echo htmlentities($result->id); ?>"><i class="lni lni-pencil p-2"></i></a>
