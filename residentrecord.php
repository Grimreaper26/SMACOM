...
if (isset($_REQUEST['del'])) {
    ...
    try {
        ...
        // Delete from residentrecord table
        $sql = "DELETE FROM residentrecord WHERE id=:id";
        ...
        echo "<script>alert('Record and corresponding user account deleted successfully!');</script>";
        echo "<script>window.location.href='residentrecord.php'</script>";
    } catch (Exception $e) {
        // Rollback transaction in case of an error
        $dbh->rollBack();
        echo "<script>alert('Failed to delete record. Error: " . $e->getMessage() . "');</script>";
    }
}
?>
<!DOCTYPE html>
    ...
    <aside id="sidebar">
        ...
        <div class="main p-5">
            <div class="d-flex justify-content-between p-4">
                ...
                <a href="#" class=" btn btn-primary text-center" data-toggle="modal" data-target="#addrecord">+ Residents</a>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo htmlentities($result->MiddleInitial); ?></td>
                                    <td><?php echo htmlentities($result->Age); ?></td>
                                    <td><?php echo htmlentities($result->CivilStatus); ?></td>
                                    <td><?php echo htmlentities($result->Gender); ?></td>
                                    <td><?php echo htmlentities($result->ContactNumber); ?></td>
                                    <td><?php echo htmlentities($result->Sitio); ?></td>
                                    <td>
                                        <a href="residentrecord.php?del=<?php echo htmlentities($result->id); ?>"><i class="lni lni-trash-can p-2" onclick="return confirm('Do you really want to delete?')"></i></a>
                                        <a href="updaterecord.php?id=<?php echo htmlentities($result->id); ?>"><i class="lni lni-pencil p-2"></i></a>
