...
if (isset($_REQUEST['del'])) {
    ...
    $uid = intval($_GET['del']);
    $sql = "DELETE FROM skofficial WHERE id=:id";
    ...
    <aside id="sidebar">
        ...
        <div class="main p-5">
            <div class="d-flex justify-content-between p-4">
                ...
                <h1>Current Sangguniang Kabataan Officials</h1>
                <a href="#" class=" btn btn-primary text-center" data-toggle="modal" data-target="#addsk">+ SK Officials</a>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="skofficial.php?del=<?php echo htmlentities($result->id); ?>"><i class="lni lni-trash-can p-2" onclick="return confirm('Do you really want to delete?')"></i></a>
                                        <a href="updatesk.php?id=<?php echo htmlentities($result->id); ?>"><i class="lni lni-pencil p-2"></i></a>
