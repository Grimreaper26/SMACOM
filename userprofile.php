...
require_once("update_usernames.php");
require_once("update_passwords.php");
...
<body>
    ...
    <aside id="sidebar">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="../dashboard/dashboardbackup.php" class="sidebar-link">
        ...
        <div class="main p-5">
            ...
            <div class="container  mt-5 ">
                <table id="" class="table   table-bordered col-12">
                    <thead>
                        <tr>
                            <th class="col-5 " scope="col">Username</th>
                            <th class="col-5 " scope="col">Password</th>
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="updateuserprofile.php?id=<?php echo htmlentities($result->id); ?>"><i class="lni lni-pencil p-2"></i></a>
