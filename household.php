    ...
    <aside id="sidebar">
        ...
        <div class="main p-5">
            <div class="d-flex justify-content-between p-4">
                ...
                <h1>List of Household and Members Information</h1>
            ...
            <div class="container  mt-5 ">
                <table id="householdtable" class="table   table-bordered col-12">
                    <thead>
                        <tr>
                            <th class="col-3 " scope="col">Number</th>
                            <th class="col-3 " scope="col">Household Number</th>
                            <th class="col-3 " scope="col">Household Members</th>

                        </tr>
                    </thead>
                    <tr>
                        <?php
                        $sql = "SELECT household FROM residentrecord"; // Adjust table name if needed
                        $households = [];
                        ...
                        <?php
                        $sql = "SELECT household, COUNT(*) AS household_count FROM residentrecord GROUP BY household";
                        $query = $dbh->query($sql);
                        ...
                        if (!empty($households)) {
                            foreach ($households as $index => $household) {
                                echo "<tr>";
                                echo "<td>" . ($index + 1) . "</td>";
                                echo '<td><a href="household_details.php?household=' . urlencode($household['household']) . '">' . htmlentities($household['household']) . '</a></td>';
                                echo "<td>" . htmlentities($household['household_count']);
                                echo "</tr>";
                            }
                        } else {
