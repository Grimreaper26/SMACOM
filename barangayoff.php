...
if (isset($_REQUEST['del'])) {
    $uid = intval($_GET['del']);
    $sql = "DELETE FROM brgyofficial WHERE id=:id";
    ...
    <aside id="sidebar">
        ...
        <div class="main p-5">
            <div class="d-flex justify-content-between p-4">
                ...
                <a href="#" class=" btn btn-primary text-center" data-toggle="modal" data-target="#addofficial">+ Officials</a>
            </div>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="barangayoff.php?del=<?php echo htmlentities($result->id); ?>"><i class="lni lni-trash-can p-2" onclick="return confirm('Do you really want to delete?')"></i></a>
                                        <a href="updatebrgy.php?id=<?php echo htmlentities($result->id); ?>"><i class="lni lni-pencil p-2"></i></a>
                                    </td>
                                </tr>
                        <?php
                                $cnt++;
