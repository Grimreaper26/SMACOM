    ...
    <div class="wrapper">
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="updates" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="annoucement.php" class="sidebar-link">Annoucement</a>
                        </li>
                        <li class="sidebar-item">
        ...
        <div class="main p-5">
            <div class="d-flex justify-content-between p-4">
                <h1>Annoucement</h1>
                <a href="#" class=" btn btn-primary text-center" data-toggle="modal" data-target="#addannouncement">+ Annoucement</a>
            </div>
            <div class="container  mt-5 ">
                <table id="brgyannouncement" class="table   table-bordered col-12">
                    <thead>
                        <tr>
                            <th class="col-3 " scope="col">Announcement</th>
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    <td><?php echo htmlentities($result->Announcement); ?></td>
                                    <td><?php echo htmlentities($result->Description); ?></td>
                                    <td><?php echo htmlentities($result->Date); ?></td>
                                    <td>
                                        <a href="announcement.php?del=<?php echo htmlentities($result->id); ?>"><i class="lni lni-trash-can p-2" onclick="return confirm('Do you really want to delete?')"></i></a>
                                        <a href="updateannouncement.php?id=<?php echo htmlentities($result->id); ?>"><i class="lni lni-pencil p-2"></i></a>
                                    </td>
                                </tr>
                        <?php
                            }
