...
include('modaltrans.php');
include('includes_admin/footer.php');
require_once("session.php");

if (isset($_REQUEST['del'])) {
    $uid = intval($_GET['del']);
    $sql = "DELETE FROM transparency WHERE id=:id";
    ...
    <aside id="sidebar">
        ...
        <div class="main p-5">
            <div class="d-flex justify-content-between p-4">
                ...
                <a href="#" class=" btn btn-primary text-center" data-toggle="modal" data-target="#addtrans">+ Add Details</a>
            </div>
            <div class="row pt-5">
                        ...
                        <tbody>
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td> <a href="transparency.php?del=<?php echo htmlentities($result->id); ?>"><i class="lni lni-trash-can p-2" onclick="return confirm('Do you really want to delete?')"></i></a>
                                            <a href="updatetransparency.php?id=<?php echo htmlentities($result->id); ?>"><i class="lni lni-pencil p-2"></i></a>
                                        </td>
                                    </tr>
                            <?php
                                }
