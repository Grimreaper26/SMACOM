    ...
    <aside id="sidebar">
        ...
        <div class="main p-5">
            <div class="d-flex justify-content-between p-4">
                ...
                <h1>News</h1>
                <a href="#" class=" btn btn-primary text-center" data-toggle="modal" data-target="#addnews">+ News</a>

            </div>

            <div class="container  mt-5 ">
                <table id="brgynews" class="table   table-bordered col-12">
                    <thead>
                        <tr>
                            <th class="col-3 " scope="col">News</th>
                    ...
                    <tbody>
                        ...
                        ?>
                                ...
                                <tr>
                                    <td><?php echo htmlentities($result->News); ?></td>
                                    <td><?php echo htmlentities($result->Description); ?></td>
                                    <td><?php echo htmlentities($result->Date); ?></td>

                                    <td>
                                        <a href="news.php?del=<?php echo htmlentities($result->id); ?>"><i class="lni lni-trash-can p-2" onclick="return confirm('Do you really want to delete?')"></i></a>
                                        <a href="updatenews.php?id=<?php echo htmlentities($result->id); ?>"><i class="lni lni-pencil p-2"></i></a>
